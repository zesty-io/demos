      ...
      <div className='results'>
        {filteredArticles.map((art) => (
          <div key={art.zuid} className='result'>
            ...
            <div className='resultsText'>
              <h4>
                <a href={art.path_full}>{art.title}</a>
              </h4>
              <p>
                {art.description.replace(/(<([^>]+)>)/gi, '').substring(0, 200)}
              </p>
              <a className='path' href={art.uri}>
                {art.uri}
              </a>{' '}
              -{' '}
              <a className='cached' href={art.uri}>
                Cached
              </a>
            </div>
          </div>
        ...
        <DeveloperHint>
          <p>
            ...
            <a
              target='_blank'
              href='https://4q6k83l9-dev.preview.zesty.io/-/gql/movies_and_shows.json'
            >
              https://4q6k83l9-dev.preview.zesty.io/-/gql/movies_and_shows.json
            </a>{' '}
