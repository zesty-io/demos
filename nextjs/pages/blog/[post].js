...
const PostPage = ({ post }) => (
  <Layout>
   <Wrapper>
    ...
    <div>
      <p>
        The data that is being fetched is using a Parsley custom endpoint. Below
        is the Parsley syntax used.
      </p>
      ...
      <hr />
      <div className='code'>
        &#123;&#123; if &#123;get_var.path&#125; &#125;&#125; [&#123;&#123;each
        movies_and_shows as show where path_part LIKE '&#123;get_var.path&#125;
        ' &#125;&#125; &#123;&#123;show.toJSON()&#125;&#125; &#123;&#123;if
        &#123;show._length&#125; != &#123;show._num&#125; &#125;&#125;,
        &#123;&#123;end-if&#125;&#125; &#123;&#123;end-each&#125;&#125;]
        &#123;&#123;else&#125;&#125; [&#123;&#123;each movies_and_shows as show
        limit &#123;get_var.limit&#125; &#125;&#125;
        &#123;&#123;show.toJSON()&#125;&#125; &#123;&#123;if
        &#123;show._length&#125; != &#123;show._num&#125; &#125;&#125;,
        &#123;&#123;end-if&#125;&#125; &#123;&#123;end-each&#125;&#125;]
